...
import { pickAndUploadPdf } from "../lib/supabase/documents";
  ...
  return (
    <GradientBackground>
        ...
        <FadeIn>
          <View style={styles.header}>
            ...
            <View style={styles.headerActions}>
              <PressableScale
                onPress={() => navigate("/chats" as never)}
                variant="button"
                haptic="selection"
              ...
              <PressableScale
                ...
                variant="button"
                haptic="light"
                style={[styles.avatar, { backgroundColor: colors.brandPrimary }]}
      ...
      <AddDocumentSheet
        ...
        onSelectWord={() =>
          Alert.alert("Coming soon", "Word upload is available in the next update.")
        }
        onSelectLink={() =>
          Alert.alert("Coming soon", "URL paste is planned for v2.")
        }
      />
    </GradientBackground>
  );
